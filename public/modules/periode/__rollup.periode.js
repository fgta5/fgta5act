 ...
 *
 * This module is generated by fgta5 generator at 22 Nov 2025 01:42
 ************************************************************************/
...
const filepath = join('public/modules/periode', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/periode/periode-${previousVersionNumber}.min.mjs`
...
export default {
	...
	output: {
		file: `public/modules/periode/periode-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
