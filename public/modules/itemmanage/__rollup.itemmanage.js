 ...
 *
 * usage:
 * npx rollup -c ./public/modules/itemmanage/__rollup.itemmanage.js
 *
 * This module is generated by fgta5 generator at 9 Dec 2025 15:05
 ************************************************************************/
...
const banner = `itemmanage
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/itemmanage', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/itemmanage/itemmanage-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/itemmanage/itemmanage.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/itemmanage/itemmanage-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
