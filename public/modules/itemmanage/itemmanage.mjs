...
import * as itemmanageHeaderList from './itemmanageHeaderList.mjs' 
import * as itemmanageHeaderEdit from './itemmanageHeaderEdit.mjs' 
import * as Extender from './itemmanage-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			itemmanageHeaderList, 
			itemmanageHeaderEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				itemmanageHeaderList.init(self, args), 
				itemmanageHeaderEdit.init(self, args), 
			...
			const modNameList = ['itemmanageHeaderEdit']
...
async function render(self) {
	try {
		...
		// itemmanage-ext.mjs, export function extendPage(self) {} 
