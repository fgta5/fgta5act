 ...
 *
 * usage:
 * npx rollup -c ./public/modules/paymtype/__rollup.paymtype.js
 *
 * This module is generated by fgta5 generator at 28 Nov 2025 19:13
 ************************************************************************/
...
const banner = `paymtype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/paymtype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/paymtype/paymtype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/paymtype/paymtype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/paymtype/paymtype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
