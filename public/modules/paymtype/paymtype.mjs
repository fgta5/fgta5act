...
import * as paymtypeHeaderList from './paymtypeHeaderList.mjs' 
import * as paymtypeHeaderEdit from './paymtypeHeaderEdit.mjs' 
import * as Extender from './paymtype-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				paymtypeHeaderList.init(self, args), 
				paymtypeHeaderEdit.init(self, args), 
			...
			const modNameList = ['paymtypeHeaderEdit']
...
async function render(self) {
	try {
		...
		// paymtype-ext.mjs, export function extendPage(self) {} 
