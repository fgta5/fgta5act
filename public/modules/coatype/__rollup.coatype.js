 ...
 *
 * usage:
 * npx rollup -c ./public/modules/coatype/__rollup.coatype.js
 *
...
const banner = `coatype
*
* build at ${currentdate}
`

export default {
	input: "public/modules/coatype/coatype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/coatype/coatype.min.mjs`, // Lokasi output file hasil bundle
