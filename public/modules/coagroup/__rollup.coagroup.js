 ...
 *
 * usage:
 * npx rollup -c ./public/modules/coagroup/__rollup.coagroup.js
 *
 * This module is generated by fgta5 generator at 20 Nov 2025 23:56
 ************************************************************************/
...
const banner = `coagroup
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/coagroup', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/coagroup/coagroup-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/coagroup/coagroup.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/coagroup/coagroup-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
