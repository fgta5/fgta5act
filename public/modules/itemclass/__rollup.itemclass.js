 ...
 *
 * This module is generated by fgta5 generator at 14 Dec 2025 02:11
 ************************************************************************/
...
const banner = `itemclass
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/itemclass', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/itemclass/itemclass-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/itemclass/itemclass.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/itemclass/itemclass-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
