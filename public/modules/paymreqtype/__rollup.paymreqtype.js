 ...
 *
 * usage:
 * npx rollup -c ./public/modules/paymreqtype/__rollup.paymreqtype.js
 *
 * This module is generated by fgta5 generator at 28 Nov 2025 03:12
 ************************************************************************/
...
const banner = `paymreqtype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/paymreqtype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/paymreqtype/paymreqtype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/paymreqtype/paymreqtype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/paymreqtype/paymreqtype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
