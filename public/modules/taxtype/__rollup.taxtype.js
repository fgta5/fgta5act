...
const filepath = join('public/modules/taxtype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/taxtype/taxtype-${previousVersionNumber}.min.mjs`
...
export default {
	...
	output: {
		file: `public/modules/taxtype/taxtype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
