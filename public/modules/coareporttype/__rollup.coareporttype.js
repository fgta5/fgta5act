 ...
 *
 * usage:
 * npx rollup -c ./public/modules/coareporttype/__rollup.coareporttype.js
 *
 * This module is generated by fgta5 generator at 23 Oct 2025 12:59
 ************************************************************************/
...
const banner = `coareporttype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/coareporttype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/coareporttype/coareporttype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/coareporttype/coareporttype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/coareporttype/coareporttype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
