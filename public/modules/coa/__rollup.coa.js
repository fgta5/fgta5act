 ...
 *
 * usage:
 * npx rollup -c ./public/modules/coa/__rollup.coa.js
 *
 * This module is generated by fgta5 generator at 23 Oct 2025 17:49
 ************************************************************************/
...
const filepath = join('public/modules/coa', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/coa/coa-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/coa/coa.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/coa/coa-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
