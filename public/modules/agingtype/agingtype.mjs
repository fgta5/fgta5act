...
import * as agingtypeHeaderList from './agingtypeHeaderList.mjs' 
import * as agingtypeHeaderEdit from './agingtypeHeaderEdit.mjs' 
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				agingtypeHeaderList.init(self, args), 
				agingtypeHeaderEdit.init(self, args), 
			...
			const modNameList = ['agingtypeHeaderEdit']
...
async function render(self) {
	try {
		...
		// agingtype-ext.mjs, export function extendPage(self) {} 
