 ...
 *
 * usage:
 * npx rollup -c ./public/modules/coacategory/__rollup.coacategory.js
 *
 * This module is generated by fgta5 generator at 10 Oct 2025 18:42
 ************************************************************************/
...
const banner = `coacategory
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/coacategory', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/coacategory/coacategory-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/coacategory/coacategory.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/coacategory/coacategory-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
