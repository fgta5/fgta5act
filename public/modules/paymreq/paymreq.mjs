...
import * as paymreqTermList from './paymreqTermList.mjs' 
import * as paymreqTermEdit from './paymreqTermEdit.mjs' 
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				...
				paymreqTermList.init(self, args), 
				paymreqTermEdit.init(self, args), 
			...
			const modNameList = ['paymreqHeaderEdit', 'paymreqDetilEdit', 'paymreqTermEdit']
