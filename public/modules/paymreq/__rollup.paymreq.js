 ...
 *
 * usage:
 * npx rollup -c ./public/modules/paymreq/__rollup.paymreq.js
 *
 * This module is generated by fgta5 generator at 14 Dec 2025 07:42
 ************************************************************************/
...
const banner = `paymreq
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/paymreq', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/paymreq/paymreq-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/paymreq/paymreq.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/paymreq/paymreq-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
