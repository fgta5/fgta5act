 ...
 *
 * usage:
 * npx rollup -c ./public/modules/depremodel/__rollup.depremodel.js
 *
 * This module is generated by fgta5 generator at 7 Dec 2025 20:46
 ************************************************************************/
...
const banner = `depremodel
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/depremodel', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/depremodel/depremodel-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/depremodel/depremodel.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/depremodel/depremodel-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
