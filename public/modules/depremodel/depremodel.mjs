...
import * as depremodelHeaderList from './depremodelHeaderList.mjs' 
import * as depremodelHeaderEdit from './depremodelHeaderEdit.mjs' 
import * as Extender from './depremodel-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			depremodelHeaderList, 
			depremodelHeaderEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				depremodelHeaderList.init(self, args), 
				depremodelHeaderEdit.init(self, args), 
			...
			const modNameList = ['depremodelHeaderEdit']
...
async function render(self) {
	try {
		...
		// depremodel-ext.mjs, export function extendPage(self) {} 
