 ...
 *
 * usage:
 * npx rollup -c ./public/modules/itemclasstype/__rollup.itemclasstype.js
 *
 * This module is generated by fgta5 generator at 9 Dec 2025 16:20
 ************************************************************************/
...
const banner = `itemclasstype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/itemclasstype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/itemclasstype/itemclasstype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/itemclasstype/itemclasstype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/itemclasstype/itemclasstype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
