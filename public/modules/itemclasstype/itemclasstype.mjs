...
import * as itemclasstypeHeaderList from './itemclasstypeHeaderList.mjs' 
import * as itemclasstypeHeaderEdit from './itemclasstypeHeaderEdit.mjs' 
import * as Extender from './itemclasstype-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			itemclasstypeHeaderList, 
			itemclasstypeHeaderEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				itemclasstypeHeaderList.init(self, args), 
				itemclasstypeHeaderEdit.init(self, args), 
			...
			const modNameList = ['itemclasstypeHeaderEdit']
...
async function render(self) {
	try {
		...
		// itemclasstype-ext.mjs, export function extendPage(self) {} 
