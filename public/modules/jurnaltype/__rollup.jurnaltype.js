 ...
 *
 * usage:
 * npx rollup -c ./public/modules/jurnaltype/__rollup.jurnaltype.js
 *
 * This module is generated by fgta5 generator at 28 Nov 2025 18:19
 ************************************************************************/
...
const banner = `jurnaltype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/jurnaltype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/jurnaltype/jurnaltype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/jurnaltype/jurnaltype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/jurnaltype/jurnaltype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
