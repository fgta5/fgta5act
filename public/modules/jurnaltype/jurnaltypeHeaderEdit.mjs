...
const obj_isheadhasdept = frm.Inputs['jurnaltypeHeaderEdit-obj_isheadhasdept']
...
const obj_isheaddeptmandatory = frm.Inputs['jurnaltypeHeaderEdit-obj_isheaddeptmandatory']
...
const obj_isdetilhasdept = frm.Inputs['jurnaltypeHeaderEdit-obj_isdetilhasdept']
...
const obj_isdetilallowselectdept = frm.Inputs['jurnaltypeHeaderEdit-obj_isdetilallowselectdept']
...
async function btn_save_click(self, evt) {
	...
	if (typeof fn_datasaving === 'function') {
		// export async function jurnaltypeHeaderEdit_dataSaving(self, dataToSave, frm) {}
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 30 Nov 2025 21:38'
