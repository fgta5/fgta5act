...
import * as jurnaltypeHeaderList from './jurnaltypeHeaderList.mjs' 
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				jurnaltypeHeaderList.init(self, args), 
...
async function render(self) {
	try {
		...
		// jurnaltype-ext.mjs, export function extendPage(self) {} 
