 ...
 *
 * usage:
 * npx rollup -c ./public/modules/bctype/__rollup.bctype.js
 *
 * This module is generated by fgta5 generator at 16 Dec 2025 14:09
 ************************************************************************/
...
const filepath = join('public/modules/bctype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/bctype/bctype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/bctype/bctype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/bctype/bctype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
