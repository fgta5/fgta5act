...
import * as bctypeHeaderList from './bctypeHeaderList.mjs' 
import * as bctypeHeaderEdit from './bctypeHeaderEdit.mjs' 
import * as bctypeCoaList from './bctypeCoaList.mjs' 
import * as bctypeCoaEdit from './bctypeCoaEdit.mjs' 
import * as bctypeItemclassList from './bctypeItemclassList.mjs' 
import * as bctypeItemclassEdit from './bctypeItemclassEdit.mjs' 
import * as bctypeDeptList from './bctypeDeptList.mjs' 
import * as bctypeDeptEdit from './bctypeDeptEdit.mjs' 
import * as Extender from './bctype-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				bctypeHeaderList.init(self, args), 
				bctypeHeaderEdit.init(self, args), 
				bctypeCoaList.init(self, args), 
				bctypeCoaEdit.init(self, args), 
				bctypeItemclassList.init(self, args), 
				bctypeItemclassEdit.init(self, args), 
				bctypeDeptList.init(self, args), 
				bctypeDeptEdit.init(self, args), 
			...
			const modNameList = ['bctypeHeaderEdit', 'bctypeCoaEdit', 'bctypeItemclassEdit', 'bctypeDeptEdit']
...
async function render(self) {
	try {
		...
		// bctype-ext.mjs, export function extendPage(self) {} 
