 ...
 *
 * usage:
 * npx rollup -c ./public/modules/bccycle/__rollup.bccycle.js
 *
 * This module is generated by fgta5 generator at 10 Dec 2025 12:14
 ************************************************************************/
...
const banner = `bccycle
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/bccycle', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/bccycle/bccycle-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/bccycle/bccycle.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/bccycle/bccycle-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
