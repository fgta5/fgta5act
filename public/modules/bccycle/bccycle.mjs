...
import * as bccycleHeaderList from './bccycleHeaderList.mjs' 
import * as bccycleHeaderEdit from './bccycleHeaderEdit.mjs' 
import * as Extender from './bccycle-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				bccycleHeaderList.init(self, args), 
				bccycleHeaderEdit.init(self, args), 
			...
			const modNameList = ['bccycleHeaderEdit']
...
async function render(self) {
	try {
		...
		// bccycle-ext.mjs, export function extendPage(self) {} 
