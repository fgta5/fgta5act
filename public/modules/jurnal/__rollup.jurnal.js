 ...
 *
 * usage:
 * npx rollup -c ./public/modules/jurnal/__rollup.jurnal.js
 *
 * This module is generated by fgta5 generator at 19 Nov 2025 14:11
 ************************************************************************/
...
const filepath = join('public/modules/jurnal', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/jurnal/jurnal-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/jurnal/jurnal.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/jurnal/jurnal-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
