...
const CurrentSectionId = Context.Sections.jurnalHeaderList
const CurrentSection = Crsl.Items[CurrentSectionId]
const CurrentState = {}

const tbl =  new $fgta5.Gridview('jurnalHeaderList-tbl')
const pnl_search = document.getElementById('jurnalHeaderList-pnl_search')
const btn_gridload = new $fgta5.ActionButton('jurnalHeaderList-btn_gridload') 

export const Section = CurrentSection
export const SearchParams = {}

export async function init(self, args) {
	console.log('initializing jurnalHeaderList ...')
	...
	try {
		...
		const obj_searchtext = document.getElementById('jurnalHeaderList-txt_searchtext')
		const btn_load = document.getElementById('jurnalHeaderList-btn_gridload')
		...
		// jurnalHeaderList-ext.mjs, export function initSearchParams(self, SearchParams) {} 
...
async function openRow(self, tr) {
	...
	const jurnalHeaderEdit = self.Modules.jurnalHeaderEdit
	jurnalHeaderEdit.clearForm(self, 'loading...')
...
function tbl_cellclick(self, evt) {
	...
	const jurnalHeaderEdit = self.Modules.jurnalHeaderEdit
	jurnalHeaderEdit.Section.show({}, (evt)=>{
		openRow(self, tr)
	})
...
async function tbl_loadData(self, params={}) {
	console.log('loading jurnalHeader data')
	console.log(params)
