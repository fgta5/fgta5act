...
export async function init(self, args) {
	...
	obj_frgrate.addEventListener('changed', (evt)=>{
		...
		if (typeof fn_changed === 'function') {
			...
			fn_changed(self, obj_frgrate, frm, evt)
		} else {	
			console.warn('Extender.obj_frgrate_changed is not implemented')
		}		
	})
...
async function btn_save_click(self, evt) {
	...
	if (typeof fn_datasaving === 'function') {
		// export async function jurnalHeaderEdit_dataSaving(self, dataToSave, frm) {}
...
async function btn_about_click(self, evt) {
	...
	pageHelper.openSection(self, 'fAbout-section', params, async ()=>{
		...
		if ( document.getElementById('fAbout-section-footer') == null) {
			...
			divFooter.innerHTML = 'This module is generated by fgta5 generator at 29 Nov 2025 14:34'
