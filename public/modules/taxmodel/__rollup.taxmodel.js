 ...
 *
 * usage:
 * npx rollup -c ./public/modules/taxmodel/__rollup.taxmodel.js
 *
 * This module is generated by fgta5 generator at 15 Dec 2025 22:40
 ************************************************************************/
...
const banner = `taxmodel
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/taxmodel', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/taxmodel/taxmodel-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/taxmodel/taxmodel.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/taxmodel/taxmodel-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
