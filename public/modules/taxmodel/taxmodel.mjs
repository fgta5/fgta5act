...
import * as taxmodelHeaderList from './taxmodelHeaderList.mjs' 
import * as taxmodelHeaderEdit from './taxmodelHeaderEdit.mjs' 
import * as Extender from './taxmodel-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				taxmodelHeaderList.init(self, args), 
				taxmodelHeaderEdit.init(self, args), 
			...
			const modNameList = ['taxmodelHeaderEdit']
...
async function render(self) {
	try {
		...
		// taxmodel-ext.mjs, export function extendPage(self) {} 
