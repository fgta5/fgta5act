...
import * as bccoaclassHeaderList from './bccoaclassHeaderList.mjs' 
import * as bccoaclassHeaderEdit from './bccoaclassHeaderEdit.mjs' 
import * as Extender from './bccoaclass-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		self.Modules = { 
			bccoaclassHeaderList, 
			bccoaclassHeaderEdit, 
		}
		...
		try {
			...
			await Promise.all([ 
				bccoaclassHeaderList.init(self, args), 
				bccoaclassHeaderEdit.init(self, args), 
			...
			const modNameList = ['bccoaclassHeaderEdit']
...
async function render(self) {
	try {
		...
		// bccoaclass-ext.mjs, export function extendPage(self) {} 
