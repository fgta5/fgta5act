 ...
 *
 * usage:
 * npx rollup -c ./public/modules/bccoaclass/__rollup.bccoaclass.js
 *
 * This module is generated by fgta5 generator at 9 Dec 2025 19:56
 ************************************************************************/
...
const banner = `bccoaclass
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/bccoaclass', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/bccoaclass/bccoaclass-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/bccoaclass/bccoaclass.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/bccoaclass/bccoaclass-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
