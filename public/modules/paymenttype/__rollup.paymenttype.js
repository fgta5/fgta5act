 ...
 *
 * usage:
 * npx rollup -c ./public/modules/paymenttype/__rollup.paymenttype.js
 *
 * This module is generated by fgta5 generator at 27 Nov 2025 11:02
 ************************************************************************/
...
const banner = `paymenttype
*
* build at ${currentdate}
`

const filename = `version.txt`;
const filepath = join('public/modules/paymenttype', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/paymenttype/paymenttype-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/paymenttype/paymenttype.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/paymenttype/paymenttype-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
