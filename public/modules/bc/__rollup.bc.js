 ...
 *
 * usage:
 * npx rollup -c ./public/modules/bc/__rollup.bc.js
 *
 * This module is generated by fgta5 generator at 16 Dec 2025 14:18
 ************************************************************************/
...
const filepath = join('public/modules/bc', filename);

/* Hapus versi sebelumnya */
if (await isExists(filepath)) {
	const previousVersionNumber = await readFile(filepath, 'utf8');
	const previousFile = `public/modules/bc/bc-${previousVersionNumber}.min.mjs`
...
export default {
	input: "public/modules/bc/bc.mjs", // File utama yang menjadi entry point
	output: {
		file: `public/modules/bc/bc-${newVersionNumber}.min.mjs`, // Lokasi output file hasil bundle
