...
import * as bcHeaderList from './bcHeaderList.mjs' 
import * as bcHeaderEdit from './bcHeaderEdit.mjs' 
import * as Extender from './bc-ext.mjs'
...
export default class extends Module {
	...
	async main(args={}) {
		...
		try {
			...
			await Promise.all([ 
				bcHeaderList.init(self, args), 
				bcHeaderEdit.init(self, args), 
			...
			const modNameList = ['bcHeaderEdit']
...
async function render(self) {
	try {
		...
		// bc-ext.mjs, export function extendPage(self) {} 
