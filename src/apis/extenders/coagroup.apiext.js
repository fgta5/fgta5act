...
export function headerListCriteria(self, db, searchMap, criteria, sort, columns) {
	searchMap.coagroup_isparent = 'coagroup_isparent = ${coagroup_isparent}'
	searchMap.exclude_self = 'coagroup_id<>${exclude_self}'
	sort.coagroup_path = 'asc'
}
